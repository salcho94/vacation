            ...
            <div className="w-full md:w-1/3 mx-auto mt-40">
                <div className="flex flex-col p-5 rounded-lg shadow bg-white">
                    <div className="flex flex-col items-center text-center">
                        ...
                        <h2 className="mt-2 font-semibold text-gray-800">인증 토큰이 유효하지 않습니다.</h2>
                        <p className="mt-2 text-sm text-gray-600 leading-relaxed">로그인후 {process.env.LOGIN_LATER_TIME}분이 경과하였습니다 다시 로그인 해주세요</p>
                    </div>
